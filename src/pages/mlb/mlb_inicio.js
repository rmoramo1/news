...
function MLB_Inicio() {
    ...
    let teamFilter_mlb = store.stats_mlb_team;
    var byDate_mlb = teamFilter_mlb;
    byDate_mlb.sort(function (a, b) {
        return b.w - a.w;
    });
    let resultados_mlb = store.mlb;
    var byDate_nba = resultados_mlb;
                    ...
                    <div className="col-lg-2 border_right">
                        ...
                        <div className="col-12">
                            {noticiasFilter.map((item, index) => {
                                if (index < 15 && item.top_head_line == "Si" && item.deporte == "MLB") {
                                    return (
