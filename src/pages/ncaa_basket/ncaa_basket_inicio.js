...
function NCAA_BASKET_Inicio() {
    ...
    let teamFilter_ncaa_basket = store.stats_ncaa_basket_team;
    var byDate_nfl = teamFilter_ncaa_basket;
    byDate_nfl.sort(function (a, b) {
        return b.w - a.w;
    });
    let resultados_ncaa_basket = store.ncaa_basket_games;
    var byDate_nba = resultados_ncaa_basket;
                    ...
                    <div className="col-lg-2 border_right">
                        <div className="row g-0">
                            <div className="col-6 text-center py-3 bb1px">
                                <Link to="/ncaa_basketball_all_data" className="btn_gradient_light">Lineas</Link>
                            </div>
                            <div className="col-6 text-center py-3 bb1px">
                        ...
                        <div className="col-12">
                            {noticiasFilter.map((item, index) => {
                                if (index < 15 && item.top_head_line == "Si" && item.deporte == "NCAA_BASKET") {
                                    return (
                        ...
                        <div className="col-12 pt-3">
                            ...
                            {
                                resultados_ncaa_basket.map((item, index) => {
                    ...
                    <div className="col-lg-2">
                        <div className="row g-0">
                            ...
                            <div className="bb2px col-12 pb-3">
                                {
                                    teamFilter_ncaa_basket.map((item, index) => {
...
export default NCAA_BASKET_Inicio;
