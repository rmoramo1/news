...
function NHL_Inicio() {
    ...
    let teamFilter_nhl = store.stats_nhl_team;
    var byDate_nfl = teamFilter_nhl;
    byDate_nfl.sort(function (a, b) {
        return b.id - a.id;
    });
    let resultados_nhl = store.nhl;
    var byDate_nfl = resultados_nhl;
    byDate_nfl.sort(function (a, b) {
        return b.id - a.id;
    });
    return (
                    ...
                    <div className="col-lg-2 border_right">
                        <div className="row g-0">
                            <div className="col-6 text-center py-3 bb1px">
                                <Link to="/nhl_all_data" className="btn_gradient_light">Lineas</Link>
                            </div>
                            <div className="col-6 text-center py-3 bb1px">
                                <Link to="nhl_team_stats" className="btn_gradient_light">Estadísticas</Link>
                            </div>
                        </div>
                        ...
                        <div className="col-12">
                            {noticiasFilter.map((item, index) => {
                                if (index < 15 && item.top_head_line == "Si" && item.deporte == "NHL") {
                                    return (
