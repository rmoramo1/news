...
function Soccer_Inicio() {
    ...
    let teamFilter_soccer = store.stats_soccer_team;
    var byDate_nfl = teamFilter_soccer;
    byDate_nfl.sort(function (a, b) {
        return b.id - a.id;
    });
    let resultados_soccer = store.soccer;
    var byDate_nfl = resultados_soccer;
    byDate_nfl.sort(function (a, b) {
        return b.id - a.id;
    });
    return (
                    ...
                    <div className="col-lg-2 border_right">
                        <div className="row g-0">
                            <div className="col-6 text-center py-3 bb1px">
                                <Link to="/soccer_all_data" className="btn_gradient_light">Lineas</Link>
                            </div>
                            <div className="col-6 text-center py-3 bb1px">
                                <Link to="soccer_team_stats" className="btn_gradient_light">Estadísticas</Link>
                            </div>
                        </div>
                        ...
                        <div className="col-12 pt-3">
                            ...
                            {
                                resultados_soccer.map((item, index) => {
                    ...
                    <div className="col-lg-2">
                        <div className="row g-0">
                            ...
                            <div className="bb2px col-12 pb-3">
                                {
                                    teamFilter_soccer.map((item, index) => {
