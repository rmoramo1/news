...
function WNBA_Inicio() {
    ...
    let teamFilter_wnba = store.stats_wnba_team;
    var byDate_nfl = teamFilter_wnba;
    byDate_nfl.sort(function (a, b) {
        return b.w - a.w;
    });
    let resultados_wnba = store.wnba;
    var byDate_nba = resultados_wnba;
                    ...
                    <div className="col-lg-2 border_right">
                        <div className="row g-0">
                            ...
                            {/* <div className="col-12 text-center py-3 bb1px">
                                <Link to="/jugadores_wnba" className="btn_gradient_light">Jugadoras</Link>
                            </div> */}
                        </div>
                        <div className="d-none d-lg-block">
                            ...
                            <div className="col-12">
                                {noticiasFilter.map((item, index) => {
                                    if (index < 15 && item.top_head_line == "Si" && item.deporte == "WNBA") {
                                        return (
                    ...
                    <div className="col-lg-2 d-none d-lg-block">
                        <div className="row g-0">
                            ...
                            <div className="bb2px col-12 pb-3">
                                {
                                    teamFilter_wnba.map((item, index) => {
                                        let compara_day = item.season;
                                        if (item.season == compara_day) {
                                            let url_hm = "";
                                            store.logos_wnba.map((item3) => {
