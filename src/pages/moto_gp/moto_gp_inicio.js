...
import { Single_Prox_Carreras_Moto } from '../../components/single_prox_carreras_moto';
...
function Moto_GP_Inicio() {
    ...
    let teamFilter_moto_gp = store.moto_gp_drivers;
    var byDate_motp_gp = teamFilter_moto_gp;
    byDate_motp_gp.sort(function (a, b) {
        return b.w - a.w;
    });
    let resultados_moto_gp = store.moto_gp;
    var byDate_motp_gp_2 = resultados_moto_gp;
    byDate_motp_gp_2.sort(function (a, b) {
        return b.id - a.id;
    });
    return (
                    ...
                    <div className="col-lg-2 border_right">
                        <div className="row g-0">
                            <div className="col-6 text-center py-3 bb1px">
                                <Link to="/moto_gp_runs" className="btn_gradient_light">Eventos</Link>
                            </div>
                            <div className="col-6 text-center py-3 bb1px">
                        ...
                        <div className="d-none d-lg-block">
                            ...
                            <div className="col-12">
                                {noticiasFilter.map((item, index) => {
                                    if (index < 15 && item.top_head_line == "Si" && item.deporte == "MOTO_GP") {
                                        return (
                            ...
                            <div className="col-12 pt-3">
                                ...
                                {
                                    resultados_moto_gp.map((item, index) => {
                    ...
                    <div className="col-lg-2 d-none d-lg-block">
                        <div className="row g-0">
                            ...
                            <div className="bb2px col-12 pb-3">
                                {
                                    teamFilter_moto_gp.map((item, index) => {
