...
function Golf_Inicio() {
    ...
    let teamFilter_golf = store.golfer;
    var byDate_mma = teamFilter_golf;
    byDate_mma.sort(function (a, b) {
        return b.w - a.w;
    });
    let resultados_golf = store.golf;
    var byDate_mma = resultados_golf;
    byDate_mma.sort(function (a, b) {
        return b.id - a.id;
    });
    return (
                ...
                <div className="row g-0">
                    <div className="col-lg-2 border_right">
                        ...
                        <div className="col-12 pt-3">
                            ...
                            {
                                resultados_golf.map((item, index) => {
                    ...
                    <div className="col-lg-2">
                        <div className="row g-0">
                            ...
                            <div className="bb2px col-12 pb-3">
                                {
                                    teamFilter_golf.map((item, index) => {
