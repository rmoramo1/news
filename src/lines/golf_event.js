...
export default function Golf_event() {
        ...
        <div className="rounded_span m-2 bg-white shadow_spans mh_display">
            ...
            <div className="overflowX_scroll">
                <div className="row g-0 text-white text-center odds-list">
                    ...
                    <div className="col-1 bg_lines">Hour</div>
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_2}</div>
                </div>
                {/* primer */}
                {/* segunda */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_4}</div>
                </div>
                {/* segunda */}
                {/* tercera */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_6}</div>
                </div>
                {/* tercera */}
                {/* cuarta */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_8}</div>
                </div>
                {/* cuarta */}
                {/* cuarta */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_10}</div>
                </div>
                {/* cuarta */}
                {/* cuarta */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_12}</div>
                </div>
                {/* cuarta */}
                {/* sexta */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_14}</div>
                </div>
                {/* sexta */}
                {/* septima */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_16}</div>
                </div>
                {/* septima */}
                {/* octaba */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_18}</div>
                </div>
                {/* octaba */}
                {/* novena */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_20}</div>
                </div>
                {/* novena */}
                {/* diez */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_22}</div>
                </div>
                {/* diez */}
                {/* onze */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_24}</div>
                </div>
                {/* onze */}
                {/* doce */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_26}</div>
                </div>
                {/* doce */}
                {/* trece */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_28}</div>
                </div>
                {/* trece */}
                {/* catorce */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_30}</div>
                </div>
                {/* catorce */}
                {/* quince */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_32}</div>
                </div>
                {/* quince */}
                {/* dieciseis */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_34}</div>
                </div>
                {/* dieciseis */}
                {/* dieciete */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_36}</div>
                </div>
                {/* dieciete */}
                {/* dieciocho */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_38}</div>
                </div>
                {/* dieciocho */}
                {/* diesinueve */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_40}</div>
                </div>
                {/* diesinueve */}
                {/* veinte */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_42}</div>
                </div>
                {/* veinte */}
                {/* vaintiuno */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_44}</div>
                </div>
                {/* vaintiuno */}
                {/* veintidos */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_46}</div>
                </div>
                {/* veintidos */}
                {/* veintitres */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_48}</div>
                </div>
                {/* veintitres */}
                {/* veinticuatro */}
                <div className="row g-0 text-center odds-list">
                ...
                <div className="row g-0 text-center odds-list bb2px">
                    ...
                    <div className="col-2 bb1px lines">{store.golf[params.theid] && store.golf[params.theid].money_line_50}</div>
                </div>
                {/* veinticuatro */}
            </div>
        </div>
