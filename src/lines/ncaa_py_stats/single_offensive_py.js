...
export const Single_Ofensive_PY_Ncaa = props => {
    return (
                ...
                <div className="col-1">
                    <div className="col-12 bg-dark h-100 d-flex justify-content-center align-items-center ">
                        <div className="col-12 text-center">
                            <Link className="text-white" to={`/offensive_player_stats_ncaa/${props.id}`}><i className="far fa-eye"></i></Link>
                        </div>
                    </div>
                </div>
...
Single_Ofensive_PY_Ncaa.propTypes = {
    id: PropTypes.number,
