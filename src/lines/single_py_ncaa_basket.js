...
export const Single_PY__NCAA_Basket = props => {
    return (
                ...
                <div className="col-1 ">
                    <div className="col-12 bg-dark h-100 d-flex justify-content-center align-items-center ">
                        <div className="col-12 text-center">
                            <Link className="text-white" to={`/ncaa_basket_py_stats/${props.id}`}><i className="far fa-eye"></i></Link>
                        </div>
                    </div>
                </div>
...
Single_PY__NCAA_Basket.propTypes = {
    id: PropTypes.number,
