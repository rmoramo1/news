...
import { Single_MMA_Lines } from './single_mma_lines';
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-lg-8 text-center fs-4 d-flex justify-content-center align-items-center">
                                <div>
                                    ...
                                    <div className="col-12 fs-4"><span className="fw-bold font_grey">Nickname:</span><i className="fw-bold"> "{store.stats_mma_fighter[params.theid] && store.stats_mma_fighter[params.theid].nickname}"</i></div>
