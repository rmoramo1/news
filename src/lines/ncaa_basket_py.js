...
function NCAA_BASKET_Player_Stats() {
    ...
    let resultados_ncaa_bask = store.ncaa_basket_games;
    var byDate_nba = resultados_ncaa_bask;
                ...
                <div className="row g-0">
                    <div className="col-lg-2 border_right">
                        ...
                        <div className="col-12 pt-3">
                            ...
                            {
                                resultados_ncaa_bask.map((item, index) => {
                                    let compara_day = year + "-" + mes_a_dt + "-" + dia_s;
