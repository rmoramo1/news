        ...
        <div className="accordion" id="second_nba">
            <div className="accordion-item">
                <h2 className="accordion-header" id="nba_1stq_ac">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#nba_1stq" aria-expanded="true" aria-controls="nba_1stq">
                       1STQ
                    </button>
                </h2>
            </div>
            ...
            <div className="accordion-item">
                <h2 className="accordion-header" id="props_nba_tab">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#props_nba" aria-expanded="false" aria-controls="props_nba">
                        PROPS
                    </button>
                </h2>
            </div>
