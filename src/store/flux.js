const getState = ({ getStore, getActions, setStore }) => {
	return {
		store: {
			...
			bs_mx_teams: [
				"Mariachis de Guadalajara", "Rieleros de Aguascalientes", "Saraperos de Saltillo",
				"Sultanes de Monterrey", "Toros de Tijuana", "Diablos Rojos del México", "El águila de Veracruz", "Guerreros de Oaxaca", "Leones de Yucatán", "Pericos de Puebla", "Piratas de Campeche", "Tigres de Quintana Roo"
			],
			nhl_teams: [
		...
		actions: {
			//user
			user: async () => {
				const url = "https://ins-365.herokuapp.com/user";
			...
			//wnba
			logos_wnba: async () => {
				const url = "https://www.sportsdata365.com/logos_wnba";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ logos_wnba: results });
			},
			load_wnba: async () => {
				const url = "https://www.sportsdata365.com/wnba";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ wnba: results });
			},
			stats_wnba_team: async () => {
				const url = "https://www.sportsdata365.com/stats_wnba_team";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ stats_wnba_team: results });
			},
			stats_wnba_player: async () => {
				const url = "https://www.sportsdata365.com/stats_wnba_player";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ stats_wnba_player: results });
			},
			//ncaa_basket_games
			...
			//baseball_mexico  
			baseball_mexico: async () => {
				const url = "https://www.sportsdata365.com/baseball_mexico";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ baseball_mexico: results });
			},
			stats_baseball_mexico_team: async () => {
				const url = "https://www.sportsdata365.com/stats_baseball_mexico_team";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ stats_baseball_mexico_team: results });
			},
			stats_mexico_baseball_player: async () => {
				const url = "https://www.sportsdata365.com/stats_mexico_baseball_player";
				const response = await fetch(url);
				const results = await response.json();
			...
			logos_baseball_mexico: async () => {
				const url = "https://www.sportsdata365.com/logos_baseball_mexico";
				const response = await fetch(url);
				const results = await response.json();
			...
			//tennis 
			tennis: async () => {
				const url = "https://www.sportsdata365.com/tennis";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ tennis: results });
			},
			tennista: async () => {
				const url = "https://www.sportsdata365.com/tennis_player";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ tennista: results });
			},
			//nascar
			nascar: async () => {
			...
			//soccer
			soccer_tournament: async () => {
				const url = "https://www.sportsdata365.com/soccer_tournament";
				const response = await fetch(url);
				const results = await response.json();
			...
			load_perfil_tipster: async () => {
				const url = "https://ins-365.herokuapp.com/perfil_tipster";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ perfil_tipster: results });
			},
			load_picks_tipster: async () => {
				const url = "https://ins-365.herokuapp.com/picks_tipster";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ picks_tipster: results });
			},
			//muro  
			load_Upload_images: async () => {
				const url = "https://ins-365.herokuapp.com/upload";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ upload_images: results });
			},		
			load_Like_cometa: async () => {
				const url = "https://ins-365.herokuapp.com/like-comentario";
				const response = await fetch(url);
				const results = await response.json();
				setStore({ like_come: results });
			},	
			//name
			changename: username => {
