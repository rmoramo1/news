...
import { Single_Ofensive_PY } from "../../lines/ncaa_py_stats/single_offensive_py";
...
function NCAA_Football_PY_Stats() {
    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="col-12 odds-list fs-5">
                Passing Players
            </div>
            <div className="row g-0 overflowX_scroll">
                <div className="row g-0 text-center bg_lines text-white odds-list odds-list">
                ...
                </div>
                {
                    store.stats_offensive_player_ncaa_football.map((item, index) => {
                        if (item.season == year && item.team == team) {
                            return (
                                <div key={index} className="col-12 odds-list odds-list">
                                    <Single_Passing_PY
                                        id={index}
                                        name={item.name}
                                        Cmp={item.Cmp}
