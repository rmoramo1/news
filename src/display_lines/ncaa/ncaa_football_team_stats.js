...
import { Football_Team_Stats_DIS } from "../../lines/ncaa_football_team_stas"

function Ncaa_Football_Team_stats() {
    ...
    store.stats_ncaa_football_team.map((index) => {
            ...
            <div className="row g-0">
                <div className="col-lg-8">
                    <div className="title_sport bg_base_dark text-white ps-lg-5 fs-2 font_bold">
                        <div className="row g-0">
                            <div className="col-lg-8">Estadística de FOOTBALL Colegial</div>
...
export default Ncaa_Football_Team_stats;
