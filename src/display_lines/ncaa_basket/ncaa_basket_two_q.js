...
export const NCAA_BASKET_Two_q = () => {
        ...
        <div className="col-12" id="sports">
            <div className=" title_sport bg_base_dark text-white p-1 fs-5 font_bold">
                <div className="row g-0">
                    <div className="col-lg-2">2ST Q NCAA BASKETBALL</div>
            ...
            <div className="accordion-item">
                <div className="accordion-collapse collapse show" id="ncaa_basket2qCollapse" data-bs-parent="#sports">
