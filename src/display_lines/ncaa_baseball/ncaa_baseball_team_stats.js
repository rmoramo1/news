...
import { NCAA_BaseBall_Team_Stats } from "../../lines/ncaa_baseball_team_stats";

function NCAA_BASEBALL_Team_stats_display() {
    ...
    store.stats_ncaa_baseball_team.map((index) => {
...
export default NCAA_BASEBALL_Team_stats_display;