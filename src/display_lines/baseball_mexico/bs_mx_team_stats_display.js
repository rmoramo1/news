...
function BS_MX_Team_stats_display() {
    ...
    store.stats_baseball_mexico_team.map((index) => {
    ...
    let bs_mx_Filter = store.stats_baseball_mexico_team;
            ...
            <div className="row g-0">
                <div className="col-lg-8">
                    <div className="title_sport bg_base_dark text-white ps-lg-5 fs-2 font_bold">
                        <div className="row g-0">
                            <div className="col-lg-6">Stading Baseball Mexico </div>
...
export default BS_MX_Team_stats_display;